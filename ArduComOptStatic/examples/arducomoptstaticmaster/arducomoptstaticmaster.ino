 ...
 * Then we declare a pointer to an ArduComOptStaticMaster,
 ...
 * NOTE: the librairy outQueueStatic.h must be included for this to work, I do not know why...
...
/// Global Variables
int incomingMsgSizeSerial = ARDUCOMOPTSTATIC_MSGSIZE, 
    currentCharCountSerial = 0;   // how many chars we've read on Serial Terminal

char outgoingBuffer[ARDUCOMOPTSTATIC_MSGSIZE];
...
void processSerialMonitorIncoming() {
  // this is a part of the test suite, not of the ArduComOptStatic class 
...
///////////////////////////////////////////////////////////////////////////
void setup(){
  Serial.begin(ARDUCOMOPTSTATIC_BAUDRATE); // for input from Serial Monitor
  while(!Serial);
